...
import {faShoppingCart, faSignIn, faUserCircle} from "@fortawesome/free-solid-svg-icons";
        ...
        <div>
            <Navbar expand="lg">
                <div className="navContainer">
                    ...
                    <NavbarCollapse>
                        <Nav>
                            <Nav.Item>{profile ? <button type="button" onClick={Open} className="fonts"><FontAwesomeIcon icon={faUserCircle}/></button> : <Link to="/login" className="fontsLink"><FontAwesomeIcon icon={faSignIn}/></Link>}</Nav.Item>
